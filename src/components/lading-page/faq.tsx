export function FAQ() {
  ...
  return (
    <div className="my-20 flex flex-col items-center gap-16">
      <h2 className="text-4xl font-bold text-white">Dúvidas frequentes</h2>
...
function FaqItem({
  ...
  return (
    <div className="w-[351px] h-min flex flex-col gap-3 border p-5 rounded-2xl border-border-primary bg-background-primary">
